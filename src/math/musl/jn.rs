...
use super::{cos, fabs, j0, j1, log, sin, sqrt, y0, y1};
...
pub fn jn(n: isize, mut x: f64) -> f64 {
    ...
    if (ix | lx) == 0 || ix == 0x_7ff0_0000 {
         ...
         */
        tmp = nf * log(fabs(w));
        if tmp < 7.097_827_128_933_839_730_96_e+02 {
            i = nm1;
            while i > 0 {
                temp = b;
                b = b * (2. * (i as f64)) / x - a;
