    ...
    (
        ...
        paste::paste! {
            ...
            fn [< mp_edge_case_ $fn_name >]() {
                ...
                domain_test_runner2::<Op>(edge_cases::get_test_cases::<Op>());
            }
            ...
            fn [< mp_logspace_ $fn_name >]() {
                type Op = libm_test::op::$fn_name::Routine;
                domain_test_runner2::<Op>(domain_logspace::get_test_cases::<Op>());
            }
        }
    };
}
...
fn domain_test_runner2<Op>(cases: impl Iterator<Item = (Op::FTy,)>)
where
